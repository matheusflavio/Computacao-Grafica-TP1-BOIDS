...
// Construtor que inicializa o shader e carrega as fontes
GText::GText() : textShader(Shader("shaders/text.vert", "shaders/text.frag")) {
    
    // Cria matriz de projeção ortogonal para renderização 2D
    ...
    // Configura VAO e VBO para renderização de texto
